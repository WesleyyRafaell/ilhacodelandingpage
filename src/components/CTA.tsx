  ...
  return (
    <section className="relative overflow-hidden py-24 sm:py-28">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-0 left-1/4 h-80 w-80 -translate-y-1/2 rounded-full bg-gold-500/15 blur-[100px] will-change-transform" />
      ...
      <div ref={ref} className={`container-section mx-auto relative text-center reveal ${isVisible ? 'visible' : ''}`}>
        ...
        <div className={`mt-8 flex justify-center reveal reveal-delay-2 ${isVisible ? 'visible' : ''}`}>
          <a
            ...
            className="inline-flex items-center gap-2.5 rounded-full bg-gold-500 px-8 py-4 font-sans text-sm font-bold text-navy-500 shadow-xl shadow-gold-500/25 transition-all hover:bg-gold-400 hover:shadow-2xl hover:shadow-gold-500/30"
          >
